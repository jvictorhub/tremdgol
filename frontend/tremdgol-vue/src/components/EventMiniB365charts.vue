    ...
    <v-tooltip bottom>
      <template v-slot:activator="{ on, attrs }">
        <v-sheet v-bind="attrs" v-on="on" class="d-flex opacity-full flex-column justify-center align-center">
          ...
          <v-sheet class="d-flex opacity-full flex-row elevation-0 justify-space-around align-center rounded-lg text-center" min-width="200">
